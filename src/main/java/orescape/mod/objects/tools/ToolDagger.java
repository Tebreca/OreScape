...
public class ToolDagger extends ItemSword implements IHasModel
{
	...
	public void onCreated(ItemStack stack, World worldIn, EntityPlayer player) {
		...
		stack.addAttributeModifier("generic.attackSpeed", new AttributeModifier("Weapon modifier", 1, 1), EntityEquipmentSlot.MAINHAND);
		stack.addAttributeModifier("generic.attackDamage", new AttributeModifier("Weapon modifier", 0, 1), EntityEquipmentSlot.MAINHAND);
	}	
