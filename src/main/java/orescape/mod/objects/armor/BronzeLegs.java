...
public class BronzeLegs extends ItemArmor implements IHasModel
{
	public BronzeLegs(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn)
	{
...
public void onCreated(ItemStack stack, World worldIn, EntityPlayer player) {
		...
		stack.addAttributeModifier("generic.maxHealth", new AttributeModifier("generic.maxHealth", 2, 0), EntityEquipmentSlot.LEGS);
